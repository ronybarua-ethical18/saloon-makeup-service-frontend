    ...
    >
      ...
      >
        <div style={{ width: '70%', margin: 'auto' }}>
          ...
          >
          Welcome to <span style={{color:'#407aff'}}>Style Vibe </span><Image src={helloImage} width={50} height={50} alt='welcome message' />
          </h1>
          <h2 style={{color:'#b6bfce', fontWeight:400}}>Enter your information to create an account</h2>
          </div>
          <div>
